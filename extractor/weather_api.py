...
class WeatherExtractor:
     ...
     def fetch_one_city(self, city: str)-> dict:
         ...
         return{
              ...
              "sunrise_utc":    str(datetime.utcfromtimestamp(data["sys"]["sunrise"]).strftime("%Y-%m-%d %H:%M:%S")),
              "sunset_utc":     str(datetime.utcfromtimestamp(data["sys"]["sunset"]).strftime("%Y-%m-%d %H:%M:%S")),
              "extracted_at":   str(datetime.utcnow().strftime("%Y-%m-%d %H:%M:%S")),
         }
